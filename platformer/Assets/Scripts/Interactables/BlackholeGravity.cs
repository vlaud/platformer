...
public class BlackholeGravity : MonoBehaviour
{
    ...
    {
        body.linearVelocity = Vector2.Lerp(body.linearVelocity, velocity, GameManager.Inst.GameDeltaTime * 20f);
    }
    ...
    void LerpVelocity(Collider2D x, bool IsElipticalOrbit)
    {
        ...
        if (IsElipticalOrbit)
        {
            ...
            rigid.linearVelocity += (Vector2)rigid.transform.right * GameManager.Inst.GameDeltaTime * Mathf.Sqrt((PullForce * BlackholeMass) * ((2 / r) - (1 / (r * 1.5f))));
        }
        else
        {
            ...
            rigid.linearVelocity += (Vector2)rigid.transform.right * GameManager.Inst.GameDeltaTime * Mathf.Sqrt((PullForce * BlackholeMass) / r);
        }
    }
